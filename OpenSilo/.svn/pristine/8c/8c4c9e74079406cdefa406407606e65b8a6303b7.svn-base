...
- (void)viewDidLoad
{
    ...
    GSIndeterminateProgressView *progressView = [[GSIndeterminateProgressView alloc] initWithFrame:CGRectMake(0, 78,320, 2)];
...
- (UIView *)createTableView {
    ...
    UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, contentView.frame.size.width, 40)];
    labelTitle.text = titleAlert;
    labelTitle.backgroundColor = [UIColor clearColor];
    labelTitle.textAlignment = NSTextAlignmentCenter;
    labelTitle.textColor = [UIColor blackColor];
    SETFont(labelTitle, FontHeavy, 19.0f);
    
    [contentView addSubview:labelTitle];
    contentView.backgroundColor = [UIColor clearColor];
    [labelTitle release];
    
    telsTable = [[UITableView alloc] initWithFrame:CGRectMake(11, labelTitle.frame.size.height, contentView.frame.size.width - 22, 150) style:UITableViewStylePlain];
    
    telsTable.backgroundColor = [UIColor clearColor];
