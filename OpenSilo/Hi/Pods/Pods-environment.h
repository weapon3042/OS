...
// CFShareCircle
#define COCOAPODS_POD_AVAILABLE_CFShareCircle
#define COCOAPODS_VERSION_MAJOR_CFShareCircle 1
#define COCOAPODS_VERSION_MINOR_CFShareCircle 0
#define COCOAPODS_VERSION_PATCH_CFShareCircle 0
