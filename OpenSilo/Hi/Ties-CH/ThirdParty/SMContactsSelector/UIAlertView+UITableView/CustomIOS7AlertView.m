...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:ThemeColor forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0.569 green:0.097 blue:0.247 alpha:1.000] forState:UIControlStateHighlighted];
