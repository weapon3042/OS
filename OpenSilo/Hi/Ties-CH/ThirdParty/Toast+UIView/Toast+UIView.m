...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)bgColor;
...
- (void)makeToast:(NSString *)message backgroundColor:(UIColor *)bgColor {
    ...
    [self makeToast:message duration:CSToastDefaultDuration position:CSToastDefaultPosition backgroundColor:bgColor];
}
...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval position:(id)position backgroundColor:(UIColor *)bgColor {
    ...
    UIView *toast = [self viewForMessage:message title:nil image:nil backgroundColor:bgColor];
...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval position:(id)position title:(NSString *)title backgroundColor:(UIColor *)bgColor {
    UIView *toast = [self viewForMessage:message title:title image:nil backgroundColor:bgColor];
    [self showToast:toast duration:interval position:position];  
}
...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval position:(id)position image:(UIImage *)image backgroundColor:(UIColor *)bgColor {
    UIView *toast = [self viewForMessage:message title:nil image:image backgroundColor:bgColor];
    [self showToast:toast duration:interval position:position];  
}
...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval  position:(id)position title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)bgColor {
    UIView *toast = [self viewForMessage:message title:title image:image backgroundColor:bgColor];
    [self showToast:toast duration:interval position:position];  
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)bgColor {
    ...
    if(image != nil) {
        ...
        imageView.frame = CGRectMake(CSToastHorizontalPadding,
                                     CSToastVerticalPadding,
                                     CSToastImageViewWidth,
                                     CSToastImageViewHeight);
    }
    ...
    if (title != nil) {
        ...
        //SETFont(titleLabel, FontRegular, CSToastFontSize);
        ...
        if ([title respondsToSelector:@selector(sizeWithFont:constrainedToSize:lineBreakMode:)]) {
            
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
            expectedSizeTitle = [title sizeWithFont:titleLabel.font
                    constrainedToSize:maxSizeTitle
                        lineBreakMode:titleLabel.lineBreakMode];
#pragma clang diagnostic pop
            
        } else {
            expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:titleLabel.font} context:nil].size;
        }
    ...
    if (message != nil) {
        ...
        //SETFont(messageLabel, FontRegular, CSToastFontSize);
        ...
        if ([message respondsToSelector:@selector(sizeWithFont:constrainedToSize:lineBreakMode:)]) {
            
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
            expectedSizeMessage = [message sizeWithFont:messageLabel.font
                                  constrainedToSize:maxSizeMessage
                                      lineBreakMode:titleLabel.lineBreakMode];
#pragma clang diagnostic pop
            
        } else {
            expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:messageLabel.font} context:nil].size;
        }
    ...
    CGFloat wrapperWidth = MAX((imageWidth + CSToastHorizontalPadding), (longerLeft + longerWidth + CSToastHorizontalPadding));
    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding), (imageHeight + CSToastVerticalPadding));
